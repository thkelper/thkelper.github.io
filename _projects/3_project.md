...
&emsp;Over the past few months, I have embarked on an initial exploration of large models, delving into the development of LLMs across various domains.
 ...
 <br />&emsp;Leveraging the [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) framework and the high-performing Chinese base model, Qwen, we've fine-tuned our first version of the model, which is still undergoing continuous research and improvement. 
